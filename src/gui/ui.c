...
///////////////////// VARIABLES ////////////////////
lv_anim_t * bar_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * circle_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * circle_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_1, 50, 200);
